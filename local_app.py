...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'local-development-key-change-in-production'
...
if __name__ == '__main__':
    print("🚀 Starting Discounted Udemy Course Enroller...")
    print("📱 Open your browser and go to: http://localhost:5000")
    print("🔑 Login with your Udemy credentials to start!")
